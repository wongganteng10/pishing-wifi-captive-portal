...
# Buat free-wifi.sh
# ===================================
sudo tee /free-wifi/free-wifi.sh > /dev/null <<'EOL'
#!/bin/bash
...
EOL
sudo chmod +x /free-wifi/free-wifi.sh
#echo "/free-wifi/free-wifi.sh berhasil dibuat."
if [ $? -eq 0 ]; then
    echo "✅ File : /free-wifi/free-wifi.sh berhasil dibuat."
else
    echo "❌ ERROR: /free-wifi/free-wifi.sh gagal dibuat..."
    # Opsional: Tampilkan pesan error lebih detail jika Anda punya logging khusus
fi
#echo ""
...
echo "💻 sudo bash /free-wifi/free-wifi.sh"
echo "✨ Atau..."
# echo "💻 sudo ./free-wifi/free-wifi.sh"
#echo ""
