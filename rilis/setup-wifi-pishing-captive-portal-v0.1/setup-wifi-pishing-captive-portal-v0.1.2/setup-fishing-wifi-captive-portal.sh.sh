...
# ===================================
sudo tee /free-wifi/wifi_free-wifi.sh > /dev/null <<'EOL'
#!/bin/bash
...
EOL
sudo chmod +x /free-wifi/wifi_free-wifi.sh
#echo "/free-wifi/wifi_free-wifi.sh berhasil dibuat."
if [ $? -eq 0 ]; then
    echo "✅ File : /free-wifi/wifi_free-wifi.sh berhasil dibuat."
else
    echo "❌ ERROR: /free-wifi/wifi_free-wifi.sh gagal dibuat..."
    # Opsional: Tampilkan pesan error lebih detail jika Anda punya logging khusus
fi
#echo ""
...
echo "💻 sudo bash /free-wifi/wifi_free-wifi.sh"
echo "✨ Atau..."
echo "💻 sudo ./free-wifi/wifi_free-wifi.sh"
#echo ""
