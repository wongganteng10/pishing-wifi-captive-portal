...
sudo mkdir -p \
    /tmp/wifi-pishing \
    /tmp/wifi-pishing/www \
    /tmp/wifi-pishing/conf \
    /tmp/wifi-pishing/conf/backup-conf \
    /tmp/wifi-pishing/log \
    /tmp/wifi-pishing/sh \
    /tmp/wifi-pishing/portal \
...
# Perintah dos2unix
# ========================================
find /tmp/wifi-pishing -type f \( -name "*.sh" -o -name "*.conf" -o -name "*.html*" -o -name "*.htm*" -o -name "*.css*" -o -name "*.js*" \) -exec sudo dos2unix {} \;
